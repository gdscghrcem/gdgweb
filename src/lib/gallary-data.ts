  ...
  export const gallerySections: GallerySection[] = [
    {
      ...
      description: '@Pratik_Kale Sir discussed the impact of AI on various industries and its transformative potential, offering valuable insights into the future of technology.',
    ...
    },
    {
      ...
      description: 'The event explored open-source technologies and the "Code for GovTech" initiative, emphasizing contributions to government tech. Participants engaged in workshops on creating tech solutions for societal impact.',
